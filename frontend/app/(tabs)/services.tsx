...
const services = [
  ...
  },
  {
    ...
    rating: 4.9,
    category: 'tune',
    image: 'https://images.pexels.com/photos/3807162/pexels-photo-3807162.jpeg?auto=compress&cs=tinysrgb&w=800',
  },
];
      ...
      <ScrollView style={styles.categoryContainer} horizontal showsHorizontalScrollIndicator={false}>
        {categories.map(category => (
          <TouchableOpacity
            ...
            <category.icon 
              size={18} 
              color={selectedCategory === category.id ? theme.colors.white : theme.colors.gray[700]} 
            />
            <Text 
              style={[
                styles.categoryText,
